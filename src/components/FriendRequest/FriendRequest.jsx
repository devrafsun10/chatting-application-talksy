...
const FriendRequest = () => {
  ...
  return (
    <div className="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] p-[21px] w-[427px] rounded-[20px] my-[33px]  ">
      ...
      <div className="overflow-y-scroll h-[347px]">
        {
          ...
          <div className="flex">
            ...
            <div className="ml-[14px]">
              <p className=" font-tertiary font-semibold text-[18px]">{item.senderName}</p>
          ...
          <div className=" cursor-pointer">
            <button onClick={()=>handleFrnd(item)}
             className=" font-tertiary font-semibold text-[20px] text-white bg-[#1E1E1E] px-[22px] rounded-[5px] ml-[51px]">
              Accept
            </button>
          </div>
        </div>
        ...
        {/* <div className="relative flex justify-between items-center mt-[17px] border-b-2 border-black/25">
          ...
          <div className=" cursor-pointer">
            <button className=" font-tertiary font-semibold text-[20px] text-white bg-[#1E1E1E] px-[22px] rounded-[5px] ml-[51px]">
              Accept
            </button>
          </div>
        </div>
        ...
        <div className="relative flex justify-between items-center mt-[17px] border-b-2 border-black/25">
          <div className="flex">
            ...
            <div className="ml-[14px]">
              ...
              <p className="font-tertiary font-medium text-[10px] text-[#4D4D4D]/75">
