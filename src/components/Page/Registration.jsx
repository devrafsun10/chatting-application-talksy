  ...
  const handleSignup = () => {
    ...
    if (!password) {
      ...
      if (
        ...
        setPasswordError(
          "Password must be at least 6 characters and contain at least following: uppercase letters, lowercase letters, numbers"
        );
      }
    ...
    <div className="flex items-center ">
      ...
      <div className="w-1/2">
        <div className="flex justify-end mr-[70px]">
          <div>
            <h3 className="font-secondary font-bold text-[34px] text-[#11175D]">
              Get started with easily register
            </h3>
            <p className="font-secondary text-[20px] font-normal text-[#7F7F7F] mt-[13px] mb-[40px]">
              Free register and you can enjoy it
            </p>
            <div className=" relative w-[368px]">
              <p className="absolute top-[-10px] left-[20px] px-3 bg-white tracking-[2px] font-secondary text-[13px] text-[#11175D] font-semibold">
                Email Address
              </p>
              <input
                type="email"
            ...
            <div className=" relative w-[368px]">
              ...
              <div
                ...
                className=" absolute top-[25px] right-[5%] items-center cursor-pointer"
              >
            ...
            <div>
              {loading ? (
                ...
                <div className="w-[368px] mt-[30px] ">
                  <button
                    className="bg-[#1E1E1E] rounded-full w-full py-[20px] text-white font-secondary font-semibold text-[20px] relative cursor-pointer"
                  ...
                  <p className=" text-center mt-[10px] font-primary font-normal text-[13px] text-[#03014C]">
